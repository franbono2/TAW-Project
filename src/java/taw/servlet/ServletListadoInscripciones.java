 ...
 * @author migue
 */
@WebServlet(name = "ServletListadoInscripciones", urlPatterns = {"/ServletListadoInscripciones"})
public class ServletListadoInscripciones extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Inscripcion> listaInscripciones = this.inscripcionFacade.inscripcionesUsuario(usuario);
